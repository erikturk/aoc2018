...
print(max(totalsleeptime,key=totalsleeptime.get)* max(sleeptime[max(totalsleeptime,key=totalsleeptime.get)], key=sleeptime[max(totalsleeptime,key=totalsleeptime.get)].get))
